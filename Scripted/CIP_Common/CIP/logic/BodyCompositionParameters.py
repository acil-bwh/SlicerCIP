...
class BodyCompositionParameters(object):  
  ...
  allowedCombinations = \
      (("UNDEFINED", "UNDEFINEDTYPE",	    0,    0,    0,    -INF,  INF, -INF,  INF, 0),
      ("ABDOMEN", "VISCERALFAT",            0.1, 0.39, 0.79, -250,  50,  1300, -550, 0),
      ("PARAVERTEBRAL","MUSCLE",            0.95, 0.23, 0.10, -50,   90,  140,   20,  1),
      ("RIGHT","SUBCUTANEOUSFAT",           0.68, 0.86,  0.9, -200,  0,   1300, -550, 0),
      ("LEFT", "PECTORALISMAJOR",	        0.74, 0.1,  0.1,    -50, 90,   140,  20,  1),
      ("PARAVERTEBRAL", "SUBCUTANEOUSFAT",  0.80, 0.58, 0.11, -200,  0,   1300, -550, 0),
      ("LEFT", "PECTORALISMINOR",           0.75, 0.34, 0.34, -50,   90,   140,  20,  1),
      ("RIGHT","PECTORALISMAJOR",	        0.64, 0,    0,     -50,  90,   140,  20,  1),
      ("RIGHT","PECTORALISMINOR",           0.65, 0.24, 0.24 , -50,  90,   140,  20,  1),
      ("LEFT","SUBCUTANEOUSFAT",            0.78, 0.96, 1,    -200,  0,   1300, -550, 1),
      ("LIVER","UNDEFINEDTYPE",             0.79, 0.87, 0.06, -INF,  INF,  140,  20, 0),
      ("SPLEEN","UNDEFINEDTYPE",            0.61, 0.42, 0.64, -INF,  INF,  140,  20, 0))
