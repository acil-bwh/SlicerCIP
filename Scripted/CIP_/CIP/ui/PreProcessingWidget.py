...
class PreProcessingWidget():
    ...
    def warningMessageForLM(self):
        answer = qt.QMessageBox.question(slicer.util.mainWindow(), self.__moduleName__,
                                         'Do you want to create a lung label map?',
...
class PreProcessingLogic(object):
    ...
    def filterCT(self, input_ct, method, s_rad=[3, 3, 3], c_rad=[5, 5, 5], noisePower=3.0, h=0.8, ps=2.0,
                 n_rad=[1, 1, 1], sigma=1.0):
