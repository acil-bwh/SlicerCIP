/*=========================================================================
  ...
  Module:    vtkGlyph3DWithScaling.h
...
=========================================================================*/
// .NAME vtkGlyph3DWithScaling - copy oriented and scaled glyph geometry to every input point
// .SECTION Description
// vtkGlyph3DWithScaling is a filter that copies a geometric representation (called
...
#include "vtkSlicerParticlesDisplayModuleMRMLExport.h" // For export macro
...
class VTK_SLICER_PARTICLESDISPLAY_MODULE_MRML_EXPORT vtkGlyph3DWithScaling : public vtkPolyDataAlgorithm
{
public:
  ...
  // Turn on/off scaling of source geometry along X
...
protected:
  ...
  int ScalingY;// Determine whether scaling of geometry is performed along Y
  int ScalingZ;// Determine whether scaling of geometry is performed along Z
...
private:
  vtkGlyph3DWithScaling(const vtkGlyph3DWithScaling&);  // Not implemented.
  void operator=(const vtkGlyph3DWithScaling&);  // Not implemented.
};

// Description:
// Return the method of scaling as a descriptive character string.
inline const char *vtkGlyph3DWithScaling::GetScaleModeAsString(void)
{
...
inline const char *vtkGlyph3DWithScaling::GetColorModeAsString(void)
{
