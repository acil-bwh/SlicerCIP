...
#ifndef __qSlicerRegionTypeModule_h
#define __qSlicerRegionTypeModule_h
...
class Q_SLICER_QTMODULES_REGIONTYPE_EXPORT
...
public:
  ...
  explicit qSlicerRegionTypeModule(QObject *parent=0);
  virtual ~qSlicerRegionTypeModule();
...
protected:
  QScopedPointer<qSlicerRegionTypeModulePrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qSlicerRegionTypeModule);
  Q_DISABLE_COPY(qSlicerRegionTypeModule);
};
