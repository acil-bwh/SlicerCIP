...
#ifndef __itkcipChestConventions_h
#define __itkcipChestConventions_h
 ...
 */
class VTK_SLICER_REGIONTYPE_MODULE_MRML_EXPORT ChestConventions
{
public:
  ~ChestConventions();
  ChestConventions();
