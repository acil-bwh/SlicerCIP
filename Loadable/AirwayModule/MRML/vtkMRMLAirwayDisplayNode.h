/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkMRMLAirwayDisplayNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

  =========================================================================auto=*/
///  vtkMRMLAirwayDisplayNode - MRML node to represent display properties for tractography.
///
/// vtkMRMLAirwayDisplayNode nodes store display properties of trajectories
/// from tractography in diffusion MRI data, including color type (by bundle, by fiber,
/// or by scalar invariants), display on/off for tensor glyphs and display of
/// trajectory as a line or tube.
//

#ifndef __vtkMRMLAirwayDisplayNode_h
#define __vtkMRMLAirwayDisplayNode_h
...
class vtkMRMLAirwayDisplayNode : public vtkMRMLModelDisplayNode
{
 public:
 static vtkMRMLAirwayDisplayNode *New (  );
  vtkTypeMacro(vtkMRMLAirwayDisplayNode, vtkMRMLModelDisplayNode);
  ...
  ///
  /// Get node XML tag name (like Volume, Airway)
  virtual const char* GetNodeTagName() {return "AirwayDisplayNode";};
 ...
 protected:
  vtkMRMLAirwayDisplayNode ( );
  ~vtkMRMLAirwayDisplayNode ( );
  vtkMRMLAirwayDisplayNode ( const vtkMRMLAirwayDisplayNode& );
  void operator= ( const vtkMRMLAirwayDisplayNode& );
